...
define('ELFINDER_PHP_ROOT_PATH', dirname(__FILE__) . '/../../elfinder/php');

function elFinderAutoloader($name) {
	$map = array(
//		'elFinder' => ELFINDER_PHP_ROOT_PATH . '/elFinder.class.php',
//		'elFinder_original' => ELFINDER_PHP_ROOT_PATH . '/elFinder.class.php',
		'elFinder' => dirname(__FILE__) . '/elFinder_xh.class.php',
